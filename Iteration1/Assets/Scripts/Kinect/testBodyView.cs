...
// Used to draw skeleton
public class testBodyView : MonoBehaviour
{
    ...
    private Dictionary<Kinect.JointType, Kinect.JointType> _BoneMap = new Dictionary<Kinect.JointType, Kinect.JointType>()
{
    ...
    void Update()
    {
        ...
        _KinectData = BodyManager.GetComponent<KinectDataHandler>();
        if (_KinectData == null)
        {
            return;
        }

        Kinect.Body[] data = _KinectData.GetData();
        if (data == null)
        {
            return;
        }
